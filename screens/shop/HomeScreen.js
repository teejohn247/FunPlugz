...
import { StyleSheet, Dimensions, View, Text, ScrollView, FlatList, TextInput, Image, SafeAreaView } from 'react-native';
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: 'transparent' }} forceInset={{ top: 'always', horizontal: 'never' }}>
      ...
      <Ionicons name="md-checkmark-circle" size={32} color="green" />;
        ...
        <View style={{ color: 'black', padding: 20, marginLeft: 'auto', marginRight: 'auto', fontFamily: 'montserrat-regular', fontSize: 22, height: 0,
        position:'relative', top: -120 }}>
          <Text style={{ fontFamily: 'montserrat', marginBottom: 2 }}> Popular Places</Text>
        </View>
